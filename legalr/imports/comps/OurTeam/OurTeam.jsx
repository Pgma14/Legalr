          ...
          <Col lg="6" md="4" sm="4" xs="12">
            <Row className="section-danger ourTeam-box text-center">
              ...
              <Col md="12" sm="12" xs="12" className="section2">
                <p>Matthew Huggins</p>
                <Col md="12" sm="12" xs="12">
                  <h1>Advisor, Product Development</h1><br></br><br></br>
                </Col>
              </Col>
          ...
          <Col lg="6" md="4" sm="4" xs="12">
           <Row className="section-danger ourTeam-box text-center">
             ...
             <Col md="12" sm="12" xs="12" className="section2">
               <p>Yevgen Kanalosh</p>
               <Col md="12" sm="12" xs="12">
                 <h1>Advisor, Business Strategy</h1><br></br><br></br>
               </Col>
             </Col>


         <Container  className="yevgensection">
                   <Row>
                     <Col className="iconsection" md="6" sm="6" xs="6">
                     <img src="ColumbiaUniversity.png" id="yevgen_columbia_logo" />
                     </Col>
                     <Col className="iconsection" md="6" sm="6" xs="6">
                     <img src="McKinsey.png" id="McKinsey_Logo" />
                     </Col>
                   </Row>
         </Container>
